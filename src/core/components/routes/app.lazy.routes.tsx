...
const Places = lazy(() => import('../../../features/places/pages/places.page'));
    ...
    return (
        <Suspense>
            <Routes>
                ...
                <Route path={items[3].path} element={<Places></Places>}></Route>
                <Route path={items[4].path} element={<Users></Users>}></Route>
                <Route path={items[5].path} element={<About></About>}></Route>
                <Route
                    path={'*'}
